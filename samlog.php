...
if(isset($_POST["login"])){
  ...
  if($isValid){
    ...
    $password_hash_from_db = '$2y$10$ruMdbr4KbzHCxbEzWiIgre.7I03ssKZRDk2/oCbia5SJUdRWN91Au';//placeholder, you can copy/paste a hash generated from sample_reg.php if you want to test it
